...
@Transactional public abstract class BaseDaoTestCase {
  //~ Instance fields --------------------------------------------------------------------------------------------------
  ...
  /**
   * Create a HibernateTemplate from the SessionFactory and call flush() and clear() on it. Designed to be used after
   * "save" methods in tests: http://issues.appfuse.org/browse/APF-178.
   *
