...
public class MailEngineTest extends BaseManagerTestCase {
   ...
   * @throws  Exception  DOCUMENT ME!
   */
  @Test public void testSendMessageWithAttachment() throws Exception {
    ...
    mailEngine.sendMessage(new String[] { "foo@bar.com" }, null, cpResource, emailBody, emailSubject, ATTACHMENT_NAME);

    mailEngine.sendMessage(new String[] { "foo@bar.com" }, mailMessage.getFrom(), cpResource, emailBody, emailSubject,
      ATTACHMENT_NAME);
  ...
  } // end method testSendMessageWithAttachment
} // end class MailEngineTest
