...
public class PersistentPasswordTokenManagerImpl implements PasswordTokenManager {
  ...
  /**
   * @see  com.ashakiran.service.impl.PasswordTokenManager#generateRecoveryToken(com.ashakiran.model.User)
   */
  ...
  /**
   * @see  com.ashakiran.service.impl.PasswordTokenManager#invalidateRecoveryToken(User, String)
   */
  ...
  /**
   * @see  com.ashakiran.service.impl.PasswordTokenManager#isRecoveryTokenValid(com.ashakiran.model.User, java.lang.String)
   */
