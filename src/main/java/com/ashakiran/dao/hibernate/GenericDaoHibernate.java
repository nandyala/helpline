...
import com.ashakiran.dao.GenericDao;
import com.ashakiran.dao.SearchException;
 ...
 *
 * <pre>
        &lt;bean id="fooDao" class="com.ashakiran.dao.hibernate.GenericDaoHibernate"&gt;
            &lt;constructor-arg value="com.ashakiran.model.Foo"/&gt;
        &lt;/bean&gt;
 * </pre>
 *
 ...
 *
 * @author   <a href="mailto:bwnoll@gmail.com">Bryan Noll</a> Updated by jgarcia: update hibernate3 to hibernate4
...
public class GenericDaoHibernate<T, PK extends Serializable> implements GenericDao<T, PK> {
   ...
   */
  @Autowired @Required public void setSessionFactory(SessionFactory sessionFactory) {
    this.sessionFactory = sessionFactory;
  }
} // end class GenericDaoHibernate
