 ...
 *
 * <p>Extend this interface if you want typesafe (no casting necessary) DAO's for your domain objects.</p>
 *
...
public interface GenericDao<T, PK extends Serializable> {
   ...
   *
   * <p>Note that if you use this method, it is imperative that your model classes correctly implement the
   * hashcode/equals methods</p>
   *
   * @return  List of populated objects
   */
