package com.ashakiran.webapp.taglib;
...
/**
 * <p>This class is designed to render a <label>tag for labeling your forms and adds an asterik (*) for required fields.
 * It was originally written by Erik Hatcher (http://www.ehatchersolutions.com/JavaDevWithAnt/).</label>
 * </p>
...
public class LabelTag extends TagSupport {
   ...
   *
   * @return  do End Tag to clear objects from memory.
   */
   ...
   *
   * @return  use the application context itself for default message resolution.
   */
