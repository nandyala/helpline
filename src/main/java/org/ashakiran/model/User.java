...
@XmlRootElement public class User extends BaseObject implements Serializable, UserDetails {
  ...
  @Override @Transient public Set<GrantedAuthority> getAuthorities() {
  ...
  @JsonIgnore @Override @XmlTransient public String getPassword() {
    return password;
  }
  ...
  @Field @Override public String getUsername() {
    return username;
  }
   ...
   */
  @Override @Transient public boolean isAccountNonExpired() {
   ...
   */
  @Override @Transient public boolean isAccountNonLocked() {
   ...
   */
  @Override @Transient public boolean isCredentialsNonExpired() {
    return !credentialsExpired;
  }
