 ...
 *           Kibler</a> Extended to implement Acegi UserDetailsService interface by David Carter david@carter.net
 *           Modified by <a href="mailto:bwnoll@gmail.com">Bryan Noll</a> to work with the new BaseDaoHibernate
 *           implementation that uses generics. Modified by jgarcia (updated to hibernate 4)
...
public class UserDaoHibernate extends GenericDaoHibernate<User, Long> implements UserDao, UserDetailsService {
   ...
   * {@inheritDoc}
   */
  @Override public String getUserPassword(Long userId) {
