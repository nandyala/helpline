 ...
 *
 * <pre>
        &lt;bean id="fooDao" class="org.ashakiran.dao.hibernate.GenericDaoHibernate"&gt;
            &lt;constructor-arg value="org.ashakiran.model.Foo"/&gt;
        &lt;/bean&gt;
 * </pre>
 *
...
public class GenericDaoHibernate<T, PK extends Serializable> implements GenericDao<T, PK> {
   ...
   * {@inheritDoc}
   */
  @Override public List<T> search(String searchTerm) throws SearchException {
    Session         sess       = getSession();
