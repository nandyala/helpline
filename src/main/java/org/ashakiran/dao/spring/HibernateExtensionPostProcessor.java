package org.ashakiran.dao.spring;
...
/**
 * <p>Adds Hibernate persistent class definitions to an existing Spring Session Factory bean, possibly defined within a
 * separate Spring configuration file in a separate jar file. By using this extension factory developers can add
 * persistent classes to an AppFuse application without modifying any of the existing AppFuse Spring configuration or
 * jar distribution files.</p>
 *
 * <p>As an example consider the following Spring bean configuration:</p>
 *
 * <pre>
   &lt;bean class=&quot;org.ashakiran.dao.spring.HibernateExtensionPostProcessor&quot;&gt;
       &lt;property name=&quot;mappingResources&quot;&gt;
           &lt;list&gt;
               &lt;value&gt;com/ashakiran/model/Foo.hbm.xml&lt;/value&gt;
           &lt;/list&gt;
       &lt;/property&gt;
       &lt;property name=&quot;annotatedClasses&quot;&gt;
           &lt;list&gt;
               &lt;value&gt;org.ashakiran.model.Bar&lt;/value&gt;
           &lt;/list&gt;
       &lt;/property&gt;
   &lt;/bean&gt;
 * </pre>
 ...
 * session factory bean configured within the standard appfuse-hibernate.jar file. And all this without needing to touch
 * the original AppFuse configuration files!</p>
 *
...
public class HibernateExtensionPostProcessor implements BeanFactoryPostProcessor {
   ...
   *
   * @throws  NoSuchBeanDefinitionException  DOCUMENT ME!
   */
  @Override
  @SuppressWarnings("unchecked")
  public void postProcessBeanFactory(ConfigurableListableBeanFactory configurableListableBeanFactory) {
    if (configurableListableBeanFactory.containsBean(sessionFactoryBeanName)) {
      BeanDefinition        sessionFactoryBeanDefinition = configurableListableBeanFactory.getBeanDefinition(
  ...
  }   // end method postProcessBeanFactory
  ...
  /**
   * Set the name of the SessionFactory bean. By default this post processor looks for a bean of name
   * &quot;sessionFactory&quot;
   *
...
} // end class HibernateExtensionPostProcessor
