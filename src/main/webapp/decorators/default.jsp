...
<a name="top"></a>
    ...
    <div class="navbar navbar-default navbar-fixed-top" role="navigation">
        <div class="navbar-header">
            ...
            <img src="${ctx}/images/world.gif" width="100" height="100" alt="HelpLine"/></a>
<%--
            <a class="navbar-brand" href="<c:url value='/'/>">HelpLine</a>
--%>
        </div>
        <div class="collapse navbar-collapse" id="navbar">
            <ul class="nav navbar-nav">
                <li><a href="${ctx}/" title="Home">Home</a></li>
                <li><a href="${ctx}/grievances" title="Grievances">Grievances</a></li>
                <li><a href="${ctx}/users" title="Volunteer Login">Volunteer Login</a></li>
    ...
    <div id="footer" class="container">
        <p>
            Created by <a href="http://ashakiran.org">AshaKiran</a>.
        </p>
    </div>
</body>
</html>
